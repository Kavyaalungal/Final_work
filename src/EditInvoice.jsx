     ...
     <CCardHeader>
      ...
      <strong style={{ fontSize: '2rem', color: '#523885', fontWeight: 'bold' }}>EDIT INVOICE</strong>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: '16px' }}>
              <CButton color="secondary" onClick={handleNewButtonClick}  
              style={{
                marginBottom: '10px',
                padding: '12px 24px',
                fontSize: '16px',
              ...
              <CButton color="primary" onClick={saveDataToAPI} disabled={!isDataUpdated}
              style={{
                marginBottom: '10px',
                padding: '12px 24px',
                fontSize: '16px',
...
//   return (
//     <div>
//       <h2>Edit Invoice CGGFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFY</h2>
//       {/* Add your edit invoice form or content here */}
//     </div>
//   );
// }
